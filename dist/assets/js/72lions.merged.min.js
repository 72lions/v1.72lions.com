...
this.page.url="http://72lions.com"+r}})}else{d.css("display","none")}document.title=a.Title+" - "+seventytwolions.Model.Locale.getPageTitle()};this.show=function(){var o=this;this.domElement.addClass("active");setTimeout(function(){o.domElement.css("opacity",1)},10)};this.hide=function(){this.domElement.removeClass("active").css("opacity",0)};var e=function(o){o.preventDefault();Router.goBack(1)}};seventytwolions.View.PostDetails.prototype=new seventytwolions.View.Base();seventytwolions.View.Footer=function(){var g;var e=this;this.domElement=$("footer");this.clickedItem=undefined;var b="<p>${text}</p>";var a;this.initialize=function(){g=this.domElement.find(".menu a");a=this.domElement.find(".latest-tweets article")};this.draw=function(){};this.postDraw=function(){f()};this.show=function(){var h=this;this.domElement.addClass("active");setTimeout(function(){h.domElement.css("opacity",1)},10)};this.hide=function(){this.domElement.removeClass("active").css("opacity",0)};this.showTweets=function(){var m,j,k,h,l;k="";m=this.getModel().get("tweets");h=m.length;for(l=0;l<h;l++){j=b;j=j.replace(/\${text}/g,d(m[l].text));k+=j}a.append(k)};var d=function(h){h=h.replace(/http([s]?):\/\/([^\ \)$]*)/g,"<a rel='nofollow' target='_blank' href='http$1://$2'>http$1://$2</a>");h=h.replace(/(^|\s)@(\w+)/g,"$1@<a href='http://www.twitter.com/$2' target='_blank'>$2</a>");h=h.replace(/(^|\s)#(\w+)/g,"$1#<a href='http://twitter.com/search/%23$2'target='_blank'>$2</a>");return h};var f=function(){g.bind("click",c)};var c=function(j){var h,i;j.preventDefault();h=e.clickedItem=$(this);i=200;$("body,html").stop().animate({scrollTop:0},i,"easeOutQuint");setTimeout(function(){e.dispatchEvent({type:"menuClicked",path:e.clickedItem.attr("href"),title:e.clickedItem.attr("title")})},i+100);h=null}};seventytwolions.View.Footer.prototype=new seventytwolions.View.Base();seventytwolions.ControllerManager.initializeController({type:"Main",id:"main",model:seventytwolions.Lookup.getModel({})});